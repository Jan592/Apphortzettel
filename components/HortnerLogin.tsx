...
// Gemeinsames Passwort für alle Hortner
const HORTNER_PASSWORD = "Hortner2024!";
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">
                Zugriff auf alle Hortzettel und Hortgruppen
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5" autoComplete="on">
              {/* Username für Browser-Passwort-Manager */}
              <input
                type="text"
                name="username"
                value="hortner"
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-sm">Hortner-Passwort *</Label>
            ...
            <div className="mt-6 p-4 bg-blue-50/80 backdrop-blur-sm border border-blue-200/50 rounded-xl">
              <p className="text-sm text-blue-900 mb-2">
                <span className="font-medium">✨ Neu:</span> Ein Login für alle Hortgruppen!
              </p>
              <p className="text-xs text-blue-800">
                Nach der Anmeldung können Sie frei zwischen allen Hortgruppen wechseln und auch alle gleichzeitig sehen.
              </p>
            </div>

            {/* Zugangsdaten Hinweis */}
            <div className="mt-4 p-4 bg-amber-50/80 backdrop-blur-sm border border-amber-200/50 rounded-xl">
              <p className="text-sm text-amber-900">
                <span className="font-medium">Hinweis:</span> Das Zugangskennwort wurde Ihnen von der Schulleitung mitgeteilt. 
